...
const KNOWN_PRODUCTS: Record<string, ProductDisplay> = {
  'arata volumizing sea salt hair spray': {
    ...
    image: '/products/Arata Volumizing Sea Salt Hair Spray.png',
  },
  'beardo dandruff control sulphate free shampoo': {
    ...
    image: '/products/Beardo Dandruff Control Sulphate Free Shampoo.png',
  },
  'beardo hair clay wax': {
    ...
    image: '/products/Beardo Hair Clay Wax.png',
  },
  "l'oreal paris hyaluron moisture sealing conditioner": {
    ...
    image: "/products/L'Oreal Paris Hyaluron Moisture Sealing Conditioner.png",
  },
  ...
  'the derma co. 1% hyaluronic sunscreen aqua gel spf 50': {
    ...
    image: '/products/The Derma Co. 1% Hyaluronic Sunscreen Aqua Gel.png',
  },
  'the derma co. 1% hyaluronic sunscreen oil-free matte gel spf 50': {
    ...
    image: '/products/The Derma Co. 1% Hyaluronic Sunscreen Oil-Free Matte Gel.png',
  },
  'the derma co. 1% kojic acid face wash': {
    ...
    image: '/products/The Derma Co. 1% Kojic Acid Face Wash.png',
  },
  'the derma co. tran-zelaic pigmentation corrector serum': {
    ...
    image: '/products/The Derma Co. Tran-Zelaic Pigmentation Corrector Serum.png',
  },
  'trimfinity edge shave dual-action mini electric razor': {
    ...
    image: '/products/Trimfinity Edge Shave Dual-Action Mini Electric Razor.png',
  },
  'urbangabru hair volumizing powder wax': {
    ...
    image: '/products/UrbanGabru Hair Volumizing Powder Wax.png',
  },
  'wild stone edge premium perfume': {
    ...
    image: '/products/Wild Stone Edge Premium Perfume.png',
  },
  'yardley london gentleman classic perfume edt': {
    ...
    image: '/products/Yardley London Gentleman Classic Perfume EDT.png',
  },
};
